...
function contact(){
  Email.send({
    SecureToken : "7097d311-6b75-438f-ad91-2af22936bd68",
    To : 'moahamedanwar082@gmail.com',
    From : "moahamedanwar082@gmail.com",
    Subject : "Fitness Empire",
    Body :  "ID: " + document.getElementById("id").value
            +"<br> Name: " + document.getElementById("name").value
            + "<br> Gmail: " +document.getElementById("email").value
